...
st.info('This is app builds a machine learning model in Python with streamlit! Source: https://github.com/dataprofessor/dp-machinelearning/blob/master/streamlit_app.py and https://www.youtube.com/@streamlitofficial')
